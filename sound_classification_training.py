...
from sound_classification_model import device
from sound_classification_split import train_dl
...
print(f'Training = Epoch: {epoch}, Loss: {avg_loss:.2f}, Accuracy: {acc:.2f}')
